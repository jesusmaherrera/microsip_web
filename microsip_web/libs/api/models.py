...
from .models_all.comun.articulos import GrupoLineas, LineaArticulos, Articulos
...
class SegimientoComunFields(models.Model):
...
class TipoCambio(SegimientoComunFields):
...
class LineaArticulos(LineaArticulos):
...
class ClavesArticulos(models.Model):
    ...
    def save(self, *args, **kwargs):    
        ...
        super(ClavesArticulos, self).save(*args, **kwargs) 
...
class CondicionPago(models.Model):
    ...
    def save(self, *args, **kwargs):    
        ...
        super(CondicionPago, self).save(*args, **kwargs)
...
class CondicionPagoPlazo(models.Model):
    id = models.AutoField(primary_key=True, db_column='PLAZO_COND_PAG_ID')
    ...
    def save(self, *args, **kwargs):    
        ...
        super(CondicionPagoPlazo, self).save(*args, **kwargs)
...
class DirCliente(models.Model):
    ...
    def save(self, *args, **kwargs):    
        ...
        super(DirCliente, self).save(*args, **kwargs)  
...
class ImpuestosArticulo(models.Model):
    ...
    def save(self, *args, **kwargs):    
        ...
        super(ImpuestosArticulo, self).save(*args, **kwargs) 
