...
triggers['DOCTOS_IN_DET_BI_PUERTA_ABIERTA'] = '''	
...
triggers['DOCTOS_IN_DET_BD_PUERTA_ABIERTA'] = '''
...
triggers['DOCTOS_IN_BU_PUERTA_ABIERTA'] = '''
        ...
        begin
            ...
            begin
                ...
                begin
                    select seguimiento
                    from articulos
                    where articulos.articulo_id = :inv_articulo_id
                    into :seguimiento;
