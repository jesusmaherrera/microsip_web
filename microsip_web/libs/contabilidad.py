...
def new_folio_poliza(tipo_poliza, fecha = None, conexion_activa = None):
    ...
    try:
        ...
        if tipo_poliza.tipo_consec == 'M':      
            tipo_poliza_det = TipoPolizaDet.objects.create(id=next_id('ID_CATALOGOS', conexion_activa), tipo_poliza=tipo_poliza, ano=fecha.year, mes=fecha.month, consecutivo = 1,)
        elif tipo_poliza.tipo_consec == 'E':
            ...
            tipo_poliza_det = TipoPolizaDet.objects.create(id=next_id('ID_CATALOGOS', conexion_activa), tipo_poliza=tipo_poliza, ano=fecha.year, mes=0, consecutivo=consecutivo,)
        elif tipo_poliza.tipo_consec == 'P':
            ...
            tipo_poliza_det = TipoPolizaDet.objects.create(id=next_id('ID_CATALOGOS', conexion_activa), tipo_poliza=tipo_poliza, ano=0, mes=0, consecutivo = consecutivo,)                                
